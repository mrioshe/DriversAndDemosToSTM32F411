...
/* Descripción de cada uno de los registros del periférico (no es necesraio para este) */
...
/* 8.4.4 GPIOx_PUPDR (dos bir por cada PIN) */
enum
{
...
/* 8.4.6 GPIOx_ODR (un bir por PIN) - este es el registro para escribir el estado de un
 * PIN (1 o 0). Este registro puede ser escrito y leído desde el software, pero no garantiza
 * una escritura "atómica", por lo cual es prefrible utiliar el registro BSRR */
 ...
 *  - Reference to the complete port (GPIOx), to hace access for the specific registers.
